      ...
      <div className="row p-3 gap-3">
              ...
              <div className="p-1 d-flex gap-3">
                ...
                <div className="d-flex">
                  ...
                  <p onClick={() => handleDeleteItem(product?.id)}>
                    <i className="fa-solid fa-trash text-success pointer"></i>
                  </p>
                </div>
              </div>
            </div>
        ...
        {cartAllProduct.length == 0 && (
          <div className="col-12">
            <marquee direction="right" scrollamount="14">
              <h1 className="text-center fs-3 text-danger mb-5">No Products Available in Cart😢</h1>
            </marquee>
          </div>
        )}
      </div>
